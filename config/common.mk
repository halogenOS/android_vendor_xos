...
# Set all versions
XOS_VERSION := XOS_$(XOS_BUILD)_$(ANDROID_VERSION)_$(shell date +%Y%m%d)_$(XOS_VERSION)-$(XOS_BUILD_TYPE)
XOS_MOD_VERSION := XOS_$(XOS_BUILD)_$(ANDROID_VERSION)_$(shell date +%Y%m%d)_$(XOS_VERSION)-$(XOS_BUILD_TYPE)
